...
namespace GAM1516_Assignment_1
{
    class Program
    {
        ...
        {
            // Some initialization
            // 0 - Just an array of Entities that we can use to test the system's add/remove/etc. 
            ...
            // Variables for assignment in the test case
            var varEntity1 = new GameEntity();
            var varEntity2 = new GameEntity();

            // 1 - Create an instance of the Entity Manager, with a given Maximum Entity Count (in this case, 4)
            ...
            // 2 - Add some Entries
            Console.WriteLine("Let's try to add 5 entries to the array - the fifth one won't add as the array has only four elements.\n");
            ...
            Console.WriteLine("Stage 4: Find the entity with ID 52 and if it exists, put it in varEntity2\n");
